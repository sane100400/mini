...
AI 부업이나 이직을 알아보다 보면 수십만 원짜리 AI 강의 결제 화면 앞까지 가게 된다. 나도 거기까지 가봤다. 그런데 결제 전에 확인할 게 있다. 비슷한 내용을 국비로, 그것도 수당을 받으면서 배우는 길이 열려 있다.
...
내일배움카드 발급자라면 누구나 참여 대상이고, 훈련비는 전액 지원이라고 안내됐다. 여기까지면 "무료 강의" 수준인데, 한 가지가 더 붙는다.

## 수당까지 준다: 지역별로 월 최대 40만~80만 원

출석률에 따라 훈련수당이 나온다. 고용노동부 안내 기준으로 지역별 상한이 다르다.
...
유료 강의는 내 돈이 나가는데, 이쪽은 교육비가 들지 않으면서 다달이 수당이 들어온다. 돈만 놓고 보면 비교가 안 된다.

## 내일배움카드가 없다면 먼저 발급해야 한다

KDT AI 캠퍼스를 비롯해 국비 교육 대부분은 국민내일배움카드(내일배움카드)가 있어야 신청한다. 취업자, 재직자, 구직자 등 상황에 따라 발급 조건이 다르니 HRD-Net 홈페이지에서 본인에게 맞는 방법을 확인하자.

발급 신청은 HRD-Net 온라인 또는 가까운 고용센터 방문으로 한다. 발급까지 시간이 걸리니, 관심 있는 과정의 모집 일정보다 여유 있게 신청하는 게 낫다. 카드가 나오면 계좌와 연결된 방식으로 훈련 비용이 처리된다.
...
반대로 직장이나 본업이 있는 사람에게는 풀타임 과정 자체가 성립하지 않는다. 그럴 때는 고용노동부의 STEP 온라인 직업교육 플랫폼이 대안이다. AI 관련 콘텐츠가 늘고 있으니 퇴근 후에 무료로 들을 만한 것부터 찾는 게 순서다. 부업 수준의 가벼운 활용이 목적이라면 몇 시간짜리 유료 강의보다 직접 만들어보면서 독학하는 쪽이 나을 수도 있다.
...
취업이 목표라면 수료생 취업 실적을 공개하는 기관의 과정을 고르는 게 낫다. 훈련기관마다 취업률, 취업 직군, 연계 기업이 다르다. HRD-Net에서 기관 정보를 조회하면 이력과 수료 통계가 나오기도 한다.
...
훈련수당은 출석률을 충족해야 나온다. 기관마다 기준이 다르지만, 보통 80% 이상 출석을 조건으로 거는 곳이 많다. 병가나 경조사 같은 결석은 출석으로 인정해주기도 하니 신청 전에 결석 처리 기준을 확인해두자.

수당이 매달 들어오지 않는 곳도 있다. 과정 수료 후 한 번에 주거나, 분기별로 주기도 한다. 생활비 계획을 세울 때 수당 지급 일정을 미리 확인해두는 게 중요하다.

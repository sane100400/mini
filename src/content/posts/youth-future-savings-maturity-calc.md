...
공시된 구조는 납입액 대비 최대 12% 매칭이다. 1,800만 원을 다 채우고 최대 매칭을 받는다고 가정하면 216만 원이다. 다만 "최대"라는 단서가 붙은 만큼 소득 구간이나 유형에 따라 매칭률이 달라질 수 있다. 본인 매칭률은 가입 신청 화면에 뜨는 값을 기준으로 봐야 한다.
...
50만 원을 무리해서 채우다 중도해지하는 것보다, 30만 원으로 36개월을 완주하는 쪽이 실제로 돌아오는 금액이 크다. 중도해지하면 정부기여금을 전액 반환하고, 이자소득 비과세 혜택도 사라진다.
...
청년미래적금에 넣는 금액과 별도로 비상금을 유지하는 게 중요하다. 적금을 중도에 깨는 가장 흔한 이유는 갑작스러운 지출이다. 이사, 의료비, 실직 같은 일이 생기면 적금을 깨야 한다는 압박에 몰린다.

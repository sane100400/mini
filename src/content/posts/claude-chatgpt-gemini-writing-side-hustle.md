...
**검색 조사와 글쓰기를 한 화면에서 오가고 싶다면 ChatGPT가 무난했다.** 글감 조사, 제목 후보, 초안까지 흐름을 끊지 않고 가는 범용성이 강점이다. 사용자가 많아서 막혔을 때 한국어로 검색하면 해결법이 바로 나온다는 점도 실무에서는 무시 못 할 장점이다.
...
실제 작업을 해보면 도구마다 한국어 감각이 조금씩 다르게 느껴진다.

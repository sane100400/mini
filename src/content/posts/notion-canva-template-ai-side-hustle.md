...
그리고 템플릿은 파일만 올려두면 쓰임이 안 보인다. 사용법을 블로그 글로 풀어두면 구매자가 자기 상황에 대입하기 쉬워진다. 발행표가 왜 필요한지, 업데이트 로그를 왜 남겨야 하는지 먼저 설명하고, 그다음에 템플릿이 그 과정을 줄여주는 도구라고 보여주는 순서다. 글에서 템플릿을 바로 팔려고 들면 광고처럼 보인다.

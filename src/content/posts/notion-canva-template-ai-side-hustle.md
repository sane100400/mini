---
title: "Notion·Canva 템플릿 판매 전 확인할 것: 사용 장면·예시 데이터·마켓"
...
템플릿은 기능보다 사용 장면을 판다. 누가, 언제, 왜 이 파일을 열어야 하는지가 먼저 정해져야 한다. 한국어 템플릿은 특히 더 그렇다. 해외 템플릿을 번역한다고 바로 상품이 되지 않는다. 한국인이 쓰는 업무 방식, 부업 기록, 쇼핑몰 운영, 전자책 판매 흐름이 따로 있다.
...
디자인도 전부 화려할 필요는 없다. 색이 많고 섹션이 복잡하면 처음에는 좋아 보여도 오래 쓰기 어렵다. Notion 템플릿은 데이터베이스 이름과 보기 방식이 중요하다. Canva 템플릿은 글자 길이가 바뀌어도 깨지지 않는지가 중요하다.
